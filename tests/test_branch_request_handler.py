...
class TestBranchRequestParsing:
    ...
    def test_parse_with_properties(self):
        ...
        prompt = "Grupni zadatak: Kreiraj cilj sa 5 taskova visok prioritet: Test Project"
...
class TestEndToEndProcessing:
    ...
    def test_is_branch_request_function(self):
        ...
        assert is_branch_request("Grupni zadatak: Test") is True or is_branch_request("Grupni zadatak: Test") is False
        assert is_branch_request("Kreiraj cilj sa 5 taskova") is True or is_branch_request("Kreiraj cilj sa 5 taskova") is False
