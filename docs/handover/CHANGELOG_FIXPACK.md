...
- 2025-12-23 – KANON-FIX-004_STATE_MEMORY_CANON – MemoryService SSOT: write_audit_events append-only kanal, AuditService memory injection, ApprovalStateService global backing store (stabilan pending/approved lifecycle) – (testovi: `.\test_runner.ps1` – ALL HAPPY PATH TESTS PASSED)
