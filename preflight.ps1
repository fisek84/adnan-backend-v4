...
try {
    ...
    $dbTablesRaw = docker exec -i adnan-backend-v4-db-1 psql -U admin -d alignment_db -t -A -c "SELECT tablename FROM pg_tables WHERE schemaname='public' ORDER BY tablename;"
