...
class NotionClient:
    ...
    async def _request_with_retry(self, method: str, endpoint: str, json: Optional[Dict] = None) -> Dict[str, Any]:
    ...
    async def query_database(
        ...
        return await self._request_with_retry("POST", f"/databases/{database_id}/query", payload)