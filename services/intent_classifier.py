...
class IntentClassifier:
    ...
    def classify(self, text: Optional[str]) -> Intent:
        ...
        # ----------------------------------------------------
        # TASK GENERATION FROM PLAN — FAZA 4  ✅ NOVO
        # ----------------------------------------------------
        if self._match(t, r"\b(razloži plan|razlozi plan|napravi taskove iz plana|generiši taskove|taskovi iz plana)\b"):
