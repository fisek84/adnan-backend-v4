...
st, res_txt = post("/api/execute/raw", {
...
st1, a1 = post("/api/ai-ops/approval/approve", {"approval_id": approval_id, "approved_by": "smoke", "note": "first"})
print("approve #1:", st1, a1)

st2, a2 = post("/api/ai-ops/approval/approve", {"approval_id": approval_id, "approved_by": "smoke", "note": "second"})
