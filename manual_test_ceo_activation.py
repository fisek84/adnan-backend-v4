...
def make_headers(
    include_token: bool = True, include_initiator: bool = True
) -> Dict[str, str]:
...
def test_toggle_api_activation() -> bool:
    ...
    payload = {"session_id": TEST_SESSION_ID, "armed": True}
...
def test_toggle_api_deactivation() -> bool:
    ...
    url = f"{BASE_URL}/api/notion-ops/toggle"
    payload = {"session_id": TEST_SESSION_ID, "armed": False}
...
def test_chat_activation_keywords() -> bool:
    ...
    payload = {
        ...
        "metadata": {"session_id": TEST_SESSION_ID, "initiator": "ceo_chat"},
    }
